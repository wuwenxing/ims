...
public class ParamUnitBean {
	...
	public String toString() {
		return "ParamUnitBean [id=" + id + ", proName=" + proName
				+ ", unitType=" + unitType + ", inputType=" + inputType
				+ ", isDynamict=" + isDynamict + ", isShow=" + isShow
				+ ", options=" + options + ", defaultVal=" + defaultVal
				+ ", desc=" + desc + "]";
	}
