 ...
 * @Date 2017年6月10日
 */
public class ImsDateUtil {
	private static final Logger logger = LoggerFactory.getLogger(ImsDateUtil.class);
    ...
    public static Date addSecond(Date date, int second) {
        if (date != null && second != 0) {
            ...
            actEndDate.setTime(date);
            actEndDate.add(Calendar.SECOND, second);
            date = actEndDate.getTime();
        }
        return date;
    }
	...
	public static void main(String args[]) {
		try {
			...
			System.out.println(ImsDateUtil.parseDateFormat("2018-03-10"+" 23:59:59"));
		} catch (Exception e) {
