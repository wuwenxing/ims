...
public class ImsMsgBindVO extends BaseVO implements Serializable{
	private static final long serialVersionUID = 2665992916752531661L;
    ...
    /**
     * 绑定类型  bind_item(物品) | bind_activity(活动)
     */
	...
	public void setBindTypeStr(String bindTypeStr) {
		this.bindTypeStr = bindTypeStr;
	}

	@Override
	public String toString() {
		return "ImsMsgBindVO [id=" + id + ", bindCode=" + bindCode + ", smsCode=" + smsCode + ", appCode=" + appCode
				+ ", bindType=" + bindType + ", ext1=" + ext1 + ", ext2=" + ext2 + ", ext3=" + ext3 + ", ext4=" + ext4
				+ ", ext5=" + ext5 + "]";
	}
}