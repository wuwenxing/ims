...
public class ActBlackListVO extends BaseVO implements Serializable {
	...
	public void setProposalStatusTxt(String proposalStatusTxt) {
		ProposalStatusTxt = proposalStatusTxt;
	}
	...
	public String toString() {
		return "ActBlackListVO [id=" + id + ", accountNo=" + accountNo + ", mobile=" + mobile + ", platform=" + platform
				+ ", env=" + env + ", activityPeriods=" + activityPeriods + ", activityName=" + activityName
