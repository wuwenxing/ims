...
public class ActTaskSettingVO extends BaseVO implements Serializable {
    /**
	 * 
	 */
     ...
     * 子集任务
     */
    private List<ActTaskSettingVO> subTaskSettings;
    
    /**
     * 活动下的物品集合
     */
    private List<ActTaskItemsVO> taskItems;
	...
	public List<ActTaskSettingVO> getSubTaskSettings() {
        return this.subTaskSettings == null ? new ArrayList<ActTaskSettingVO>():this.subTaskSettings;
    }

    public void setSubTaskSettings(
        List<ActTaskSettingVO> subTaskSettings) {
	...
	public List<ActTaskItemsVO> getTaskItems() {
		return taskItems;
	}

	public void setTaskItems(List<ActTaskItemsVO> taskItems) {
