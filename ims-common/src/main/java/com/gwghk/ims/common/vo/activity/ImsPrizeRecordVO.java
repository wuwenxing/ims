...
public class ImsPrizeRecordVO extends BaseVO implements Serializable{
     ...
     * 批量添加文件地址
     */
    private String batchAddFilePath;
    /**
     * 批量添加文件名
     */
    private String batchAddFileName;
	...
	public String getBatchAddFilePath() {
		return batchAddFilePath;
	}

	public void setBatchAddFilePath(String batchAddFilePath) {
		this.batchAddFilePath = batchAddFilePath;
	}

	public String getBatchAddFileName() {
		return batchAddFileName;
	}

	public void setBatchAddFileName(String batchAddFileName) {
		this.batchAddFileName = batchAddFileName;
	}
	 
    public BigDecimal getTradeLots() {
		return tradeLots;
	}

	public void setTradeLots(BigDecimal tradeLots) {
