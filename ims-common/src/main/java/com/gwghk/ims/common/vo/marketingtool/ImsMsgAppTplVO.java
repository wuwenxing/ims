 ...
 * @Date 2018年3月31日
 */
public class ImsMsgAppTplVO extends BaseVO implements Serializable {
	private static final long serialVersionUID = -1125379734992675974L;
	...
	public void setPushTypeTxt(String pushTypeTxt) {
		this.pushTypeTxt = pushTypeTxt;
	}
