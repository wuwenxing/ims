 ...
 * @Description: 清洗客户出金数据【FX-Gts2-真实->活动中心】
 * @author lawrence
 * @date 2017年8月10日
 *
 */
@Component
public class ActFxRealCashoutDataMergeJob implements SimpleJob {
	private static Logger logger = LoggerFactory.getLogger(ActFxRealCashoutDataMergeJob.class);
	...
	public void execute(ShardingContext context) {
		logger.info("--->开始清洗fx真实出金数据【FX-Gts2-真实->活动中心】");
		try{
			...
			logger.info("<---结束清洗fx真实出金数据【FX-Gts2-真实->活动中心】,耗时:{}s",(System.currentTimeMillis()-startTime)/1000f);
		}catch(Exception e){
			logger.error("<---结束清洗fx真实出金数据【FX-Gts2-真实->活动中心】,系统异常!!!",e);
		}
	}
}