...
<div id="assignMenuDlog" class="easyui-dialog" data-options="closed:'true', buttons:'#assignMenuDlogToolbar', modal:true, bgiframe:true, resizable:true, onClose: function(){common.removeValidatebox();}, width: 400, height: 600">
