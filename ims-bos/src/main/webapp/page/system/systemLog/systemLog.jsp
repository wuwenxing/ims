	...
	<div>
		<table class="commonTable">
			<tr>
				<th>操作时间</th>
				<td>
					<input class="easyui-datetimebox" type="text" name="startDateSearch" id="startDateSearch" data-options="editable:false" value="<ims:date type="yesterdayStart" format="yyyy-MM-dd HH:mm:ss"/>" />
					至
			...
			<tr>
				...
				<td>
					<select id="companyIdSearch" name="companyIdSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false">
						...
						<ims:enumList dataList="${companyEnum}"/>
					</select>
				</td>
				<th>请求地址</th>
				<td colspan="3">
			...
			<tr>
				...
				<td>
					<select id="logTypeSearch" name="logTypeSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false">
						<option value="">---请选择---</option>
						<ims:enumList dataList="${systemLogEnum}"/>
					</select>
				</td>
				<th>请求参数</th>
				<td colspan="3">
