...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/page/activity/base/qt/copyActivitySetting.js"
...
<body>
	<div class="easyui-tabs" id="addActSetting"
		...
		<form id="addDlogForm" class="commonForm" method="post">
			<input type="hidden" name="id" id="id" value=""> <input
				...
				value="${actSettingDTO.activityType}">
			<table class="commonTable">
				<tbody id="table_activity_baseInfo">
						...
						<td colspan="3"><select id="enableFlag" name="enableFlag"
							...
							data-options="validType:'selectValueRequired[\'#enableFlag\']', invalidMessage:'请选择', panelHeight:'auto', editable:false">
								...
								<ims:enumList dataList="${enableFlagEnum}"
									defaultVal="${actSettingDTO.enableFlag}" />
						</select></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<th>其他信息</th>
						<td><textarea name="otherMsg" id="otherMsg" maxlength="255"
	...
	<div id="tab-tools-open-onestep">
		<a href="javascript:void(0);" class="easyui-linkbutton"
			...
			onclick="copyActivitySetting.save();">确定</a> <a
			href="javascript:void(0);" class="easyui-linkbutton"
			data-options="iconCls:'icon-cancel'"
			onclick="copyActivitySetting.cancel();">返回</a>
	</div>
</body>
</html>