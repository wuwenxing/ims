...
<script type="text/javascript" src="<%=request.getContextPath()%>/jsp/activity/base/wpdh/copyActivitySetting.js" charset="UTF-8"></script>
</head>
<body>
			...
			<table class="commonTable">
			 <tbody id="table_activity_baseInfo">
				...
				<tr>
					...
					<td>
						<select id="accountOnly" name="custActCondition.accountOnly"  style="width:160px;" class="easyui-combobox easyui-validatebox" data-options="validType:'selectValueRequired[\'#accountOnly\']', invalidMessage:'请选择', panelHeight:'auto', editable:false">
				 ...
				 <tr>
					...
					<td>
					   <c:set var="platformsCcy" value="${custActCondition.platformsCcy},"/><!-- 尾号加个逗号，避免相关前缀代号eg:gts,gts2 -->
					   <c:forEach var="pform" items="${ActPlatformCcy}" >
					       <c:set var="dictCode" value="${pform.dictCode},"/>
					      <input type="checkbox" name="custActCondition.platformsCcy" value="${pform.dictCode}" <c:if test="${fn:contains(platformsCcy,dictCode)}">checked="checked"</c:if>/>${pform.dictName}
					   </c:forEach>
						   ...
						   <tr id="tr2__#_">
								...
								<td colspan="5">
									...
									<span id="taskItemValSpan__#_" style="display:none">
									   <input style="display:none" type="text" id="temp_taskItemVal__#_" curNum="_#_" name="temp_taskItemVal"  onblur="addActivitySetting.setNameParamValue('taskItemVal',this);" class="easyui-validatebox" data-options="required:false,validType: 'int'"   style="width: 120px;" maxlength="10"  value=""/>次
									</span>
